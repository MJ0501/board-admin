...
@DisplayName("DTO - Kakao OAuth2.0 인증 응답 데이터 Test")
class KakaoOAuth2ResponseTest {
    ...
    void givenMapFromJson_whenInstantiating_thenReturnsKakaoResponseObject() throws Exception {
        String serializedResponse = """
                {
                    "id": 1234567890,
                    "connected_at": "2024-01-02T00:12:34Z",
                    "properties": {
                        "nickname": "홍길동"
                    },
                    "kakao_account": {
        ...
        assertThat(result)
                ...
                .hasFieldOrPropertyWithValue("connectedAt", ZonedDateTime.of(2024, 1, 2, 0, 12, 34, 0, ZoneOffset.UTC)
